                    ...
                    <?php
                        ...
                        if(mysqli_num_rows($sql)>0){
                            while($data = mysqli_fetch_assoc($sql)){?>
                                ...
                                <td><a href="http://localhost/flippwheels/flippwheelsadmin/update_buyer.php?pr_id=<?php echo $data["id"];?>" class="edit">Update</a></td>



                                <td><a href="http://localhost/flippwheels/flippwheelsadmin/manage_buyer.php?del=<?php echo $data["id"];?>" onclick="return confirm('Are you sure?');" class="delete">Delete</a></td>
                            </tr>
