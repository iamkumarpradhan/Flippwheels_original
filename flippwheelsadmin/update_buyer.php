<?php
    ...
    if ($query_run){
      ...
      echo "<script>window.location.href='http://localhost/flippwheels/flippwheelsadmin/update_buyer.php?pr_id=<?php echo $pid;?>'</script>";
      }
    }
?><html lang="en">
<head>
...
<body>
   ...
   <!--  <div class="admin-wrapper"> -->
        ...
        <div class="admin-content">
            ...
            <div class="placee">
                <form name="form" method="post" action="http://localhost/flippwheels/flippwheelsadmin/update_buyer.php" enctype="multipart/form-data" id="uploadForm">
                <?php
                    include "dbconn.php";
                    if(isset($_GET['pr_id'])){
                        $pid = $_GET['pr_id'];
                ...
                <center><h2 class="page-title">Manage Buyer</h2></center>
                        <div class="input">
                            ...
                            <input type="submit" name="update" value="Update Buyer">
                        </div>
                    </div>
                    <?php } } ?>
                </form>
