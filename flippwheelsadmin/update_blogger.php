    ...
    if ($query_run){
      ...
      echo '<script type="text/javascript">alert("data are edited successfully...");window.location.href="http://localhost/flippwheels/flippwheelsadmin/manage_blogger.php"</script>';
      }
    else{
      die("failed to insert ".mysqli_error($con));
           echo "<script>window.location.href='http://localhost/flippwheels/flippwheelsadmin/update_blogger.php?blog_id=<?php echo $pid;?>'</script>";
      }
    }
?>
<html lang="en">
        ...
        <div class="admin-content">
            ...
            <div class="placee">
                ...
                <?php
                    ...
                    <
                    <div class="editblogger">
                        <div class="pheader">
                          <!--   <h3>Place details</h3> -->
                        </div>
                <center><h2 class="page-title">Manage Blogger</h2></center>
                        <div class="input">
                            ...
                            <input type="submit" name="update" value="Update Blogger">
                        </div>
                    </div>
                    <?php } } ?>
                </form>
