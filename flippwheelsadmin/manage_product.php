                        ...
                        if(mysqli_num_rows($sql)>0){
                            while($data = mysqli_fetch_assoc($sql)){?>
                                ...
                                <td><?php echo $data['price'];?></td>
                                 ...
                                 <td><a href="http://localhost/flippwheels/flippwheelsadmin/edit_product.php?product_id=<?php echo $data["id"];?>" class="edit">Update</a></td>


                                 <td><a href="http://localhost/flippwheels/flippwheelsadmin/manage_product.php?del=<?php echo $data["id"];?>" onclick="return confirm('Are you sure?');" class="delete">Delete</a></td>
