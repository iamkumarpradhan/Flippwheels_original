        ...
        <div class="admin-content">
            ...
            <center>    <h2 class="page-title">Manage Blogger</h2></center>
                 <table  border="3">
                    ...
                    <?php
                        include "dbconn.php";
                        $sql = mysqli_query($con, "SELECT * FROM `users` WHERE `type`='BLOGGER'");
                        ...
                        if(mysqli_num_rows($sql)>0){
                            while($data = mysqli_fetch_assoc($sql)){?>
                                ...
                                <td><?php echo $data['type'];?></td>
                                 ...
                                 <td><a href="http://localhost/flippwheels/flippwheelsadmin/update_blogger.php?blog_id=<?php echo $data["id"];?>" class="edit">Update</a></td>


                                 <td><a href="http://localhost/flippwheels/flippwheelsadmin/manage_blogger.php?del=<?php echo $data["id"];?>" onclick="return confirm('Are you sure?');" class="delete">Delete</a></td>
